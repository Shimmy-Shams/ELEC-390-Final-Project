...
def classify_motion(filepath):
    ...
    # Segment the data
    segmented_data = convert_to_segments(data_filtered, window_size=5, sample_rate=100)
    ...
    while len(data) < data_points:
        try:
            ...
            if len(data) > initial_data_points:
                ...
                segmented_data = convert_to_segments(data_ema_filtered, window_size=1, sample_rate=100)
