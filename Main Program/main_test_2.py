...
train_data_segments = de.convert_to_segments(train_data, window_size, sample_rate)
test_data_segments = de.convert_to_segments(test_data, window_size, sample_rate)
...
train_data_normalized = dpp.normalize_data(train_data)
test_data_normalized = dpp.normalize_data(test_data)
...
train_data_y = [1 if segment['Activity_Jumping'].iloc[0] == 1 else 0 for segment in train_data_normalized_segments]
test_data_y = [1 if segment['Activity_Jumping'].iloc[0] == 1 else 0 for segment in test_data_normalized_segments]
